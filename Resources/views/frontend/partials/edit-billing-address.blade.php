        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group ">
                    <label for="payment_company">Name Company</label>
            ...
            <div class="col-12 col-lg-6">
                <div class="form-group ">
                    <label for="payment_address_1">Address 1</label>
            ...
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    ...
                    <label for="payment_country">Country</label>
                    <select
                            class="form-control"
                            id="payment_country"
            ...
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    <i class="fa fa-building"></i>
                    <label for="payment_postcode">Zip/Postal Code</label>
